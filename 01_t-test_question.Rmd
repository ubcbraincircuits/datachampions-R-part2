...
# the test?
# Hint: The formula for t is (mean(y)-10)/(sd(y)/sqrt(length(y))). What do we replace y with?
obs_t = 
...
# Two sample T-test.
```{r}
# Let's make sample sizes of x = 20 and y = 40 (use the same sd).
...
# Use dt to calculate the t-distribution
...
# Calculate the t dsitribution again using the s specified below. 
