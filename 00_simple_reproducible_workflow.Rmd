...
This tutorial is meant to be run on Windows OS. Please ensure that you have Windows Subsystem for Linux (WSL) installed. You can find installation instructions here: https://docs.microsoft.com/en-us/windows/wsl/install.
...
```{r}
subdir <- "/Documents/GitHub/datachampions-R-part2"
