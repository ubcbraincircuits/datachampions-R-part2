...
```{r}
subdir <- "/Documents/Github/datachamptions-R-part2"
data_dir <- paste0( Sys.getenv("HOME"), subdir)
setwd(data_dir)
getwd()
```
#Install packages
If you do not have tidyverse and ggpubr installed, please install them.
```{bash}
# Install required applications:
sudo apt-get install -y libxml2-dev libcurl4-openssl-dev libssl-dev libv8-dev zlib1g-dev libblas-dev liblapack-dev
